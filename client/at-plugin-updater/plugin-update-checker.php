...
add_filter( 'http_request_host_is_external', 'allow_arstropica_host', 10, 3 );
function allow_arstropica_host( $allow, $host, $url ) {
    // TODO add meta value for host svn domain
    if ( $host == 'svn.mydomain.com' )
        $allow = true;
    return $allow;
}
