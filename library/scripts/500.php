<?php
    ...
    if (empty($_SESSION['cpm_error']) === false) {
        $message = $_SESSION['cpm_error'];
        unset($_SESSION['cpm_error']);
        session_write_close();
    } else {
        $message = false;
    }    
        ...
        <div id="error_table">
            <div id="error_cell">
                <div id="container">
                    ...
                    <p>500 Internal Server Error. The request was unsuccessful due to an unexpected condition encountered by the server.</p>
