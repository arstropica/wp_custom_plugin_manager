...
Class WordPress_Readme_Parser {
    ...
    function parse_readme( $file, $mode = 'content' ) {
        if ($mode == 'file') {
    ...
    function parse_readme_contents( $file_contents ) {
        ...
        // tags, conts, etc are optional and order shouldn't matter.  So we chop them only after we've grabbed their values.
        ...
        $short_desc_filtered = htmlspecialchars_decode($this->sanitize_text( $_short_description[2] ), ENT_QUOTES);
        ...
        foreach ( array('description', 'installation', 'frequently_asked_questions', 'screenshots', 'changelog', 'change_log', 'upgrade_notice', 'arbitrary_section') as $special_section ) {
